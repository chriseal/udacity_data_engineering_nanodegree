...
try: 
    cur.execute("INSERT INTO song_length (song_id, song_length)                  VALUES (%s, %s)",                  (1, 163))
except psycopg2.Error as e: 
    print("Error: Inserting Rows")
    print (e)

try: 
    cur.execute("INSERT INTO song_length (song_id, song_length)                  VALUES (%s, %s)",                  (2, 137))
except psycopg2.Error as e: 
    print("Error: Inserting Rows")
    print (e)
    
try: 
    cur.execute("INSERT INTO song_length (song_id, song_length)                  VALUES (%s, %s)",                  (3, 145))
except psycopg2.Error as e: 
    print("Error: Inserting Rows")
    print (e)
    
try: 
    cur.execute("INSERT INTO song_length (song_id, song_length)                  VALUES (%s, %s)",                  (4, 240))
except psycopg2.Error as e: 
    print("Error: Inserting Rows")
    print (e)

try: 
    cur.execute("INSERT INTO song_length (song_id, song_length)                  VALUES (%s, %s)",                  (5, 227))
except psycopg2.Error as e: 
    print("Error: Inserting Rows")
    print (e)
...
try: 
    cur.execute("INSERT INTO album_library (album_id, album_name, artist_id, year)                  VALUES (%s, %s, %s, %s)",                  (1, "Rubber Soul", 1, 1965))
except psycopg2.Error as e: 
    print("Error: Inserting Rows")
    print (e)

try: 
    cur.execute("INSERT INTO album_library (album_id, album_name, artist_id, year)                  VALUES (%s, %s, %s, %s)",                  (2, "Let It Be", 1, 1970))
except psycopg2.Error as e: 
    print("Error: Inserting Rows")
    print (e)
...
try: 
    cur.execute("\
        SELECT artist_library.artist_id, artist_name, \
            album_library.album_id, album_name, year, song_library.song_id, \
            song_name, song_length \
        FROM ((\
            artist_library JOIN album_library ON \
                artist_library.artist_id = album_library.artist_id) \
            JOIN song_library ON \
                album_library.album_id=song_library.album_id)\
            JOIN song_length ON \
                song_library.song_id=song_length.song_id;")
...
try: 
    cur.execute("INSERT INTO song_library1 (song_id, album_id, song_name, song_length)                  VALUES (%s, %s, %s, %s)",                  (2, 1, "Think For Yourself", 137 ))
except psycopg2.Error as e: 
    print("Error: Inserting Rows")
    print (e)
    
try: 
    cur.execute("INSERT INTO song_library1 (song_id, album_id, song_name, song_length)                  VALUES (%s, %s, %s, %s)",                  (3, 1, "In My Life", 145))
except psycopg2.Error as e: 
    print("Error: Inserting Rows")
    print (e)

try: 
    cur.execute("INSERT INTO song_library1 (song_id, album_id, song_name, song_length)                  VALUES (%s, %s, %s, %s)",                  (4, 2, "Let It Be", 240))
except psycopg2.Error as e: 
    print("Error: Inserting Rows")
    print (e)

try: 
    cur.execute("INSERT INTO song_library1 (song_id, album_id, song_name, song_length)                  VALUES (%s, %s, %s, %s)",                  (5, 2, "Across the Universe", 227))
except psycopg2.Error as e: 
    print("Error: Inserting Rows")
    print (e)
...
try: 
    cur.execute("INSERT INTO album_library1 (album_id, album_name, artist_name, year)                  VALUES (%s, %s, %s, %s)",                  (1, "Rubber Soul", "The Beatles", 1965))
except psycopg2.Error as e: 
    print("Error: Inserting Rows")
    print (e)

try: 
    cur.execute("INSERT INTO album_library1 (album_id, album_name, artist_name, year)                  VALUES (%s, %s, %s, %s)",                  (2, "Let It Be", "The Beatles", 1970))
except psycopg2.Error as e: 
    print("Error: Inserting Rows")
    print (e)
...
try: 
    cur.execute("INSERT INTO album_length (song_id, album_name, song_length)                  VALUES (%s, %s, %s)",                  (1, "Rubber Soul", 163 ))
except psycopg2.Error as e: 
    print("Error: Inserting Rows")
    print (e)

try: 
    cur.execute("INSERT INTO album_length (song_id, album_name, song_length)                  VALUES (%s, %s, %s)",                  (2, "Rubber Soul", 137 ))
except psycopg2.Error as e: 
    print("Error: Inserting Rows")
    print (e)   

try: 
    cur.execute("INSERT INTO album_length (song_id, album_name, song_length)                  VALUES (%s, %s, %s)",                  (3, "Rubber Soul", 145 ))
except psycopg2.Error as e: 
    print("Error: Inserting Rows")
    print (e)   

try: 
    cur.execute("INSERT INTO album_length (song_id, album_name, song_length)                  VALUES (%s, %s, %s)",                  (4, "Let It Be", 240 ))
except psycopg2.Error as e: 
    print("Error: Inserting Rows")
    print (e) 
    
try: 
    cur.execute("INSERT INTO album_length (song_id, album_name, song_length)                  VALUES (%s, %s, %s)",                  (5, "Let It Be", 227 ))
except psycopg2.Error as e: 
    print("Error: Inserting Rows")
    print (e) 
